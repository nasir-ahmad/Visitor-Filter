...
class DIT_VisitorFilter_Block_Adminhtml_Message_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("message_data") && Mage::registry("message_data")->getId() ){
				    ...
				    return Mage::helper("visitorfilter")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("message_data")->getId()));
